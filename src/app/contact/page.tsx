...
const contactMethods = [
  ...
  },
  {
    ...
    title: 'Live Chat',
    description: 'Chat with our AI agent (powered by Zauren) for instant support.',
  ...
  },
  {
    ...
    title: 'Call Us',
    description: 'Speak directly with our team for complex inquiries.',
  ...
  },
  {
    ...
    title: 'Visit Us',
    description: 'Come see us at our headquarters in Silicon Valley.',
    contact: '123 Innovation Drive, Palo Alto, CA 94301',
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactMethods.map((method, index) => (
              <Card 
                key={method.title} 
                hover 
                className={`p-6 text-center animate-slide-up animation-delay-${index * 100}`}
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="animate-slide-up animation-delay-200">
                    ...
                    <CardContent padding="none">
                      ...
                      <div className="space-y-3 text-sm">
                        <div className="flex items-start space-x-3">
                          <svg className="w-5 h-5 text-secondary-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                          </svg>
                          <div>
              ...
              <Card className="p-6 mt-6">
                <CardContent padding="none">
                  <div className="aspect-video bg-secondary-100 dark:bg-secondary-800 rounded-lg flex items-center justify-center">

          ...
          <div className="max-w-3xl mx-auto space-y-8 animate-slide-up">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl lg:text-6xl font-semibold font-mono text-balance leading-tight text-secondary-900 dark:text-white">
                Choose Your <span className="bg-gradient-to-r from-primary-600 via-accent-500 to-primary-700 bg-clip-text text-transparent">Perfect Plan</span>
              </h1>
            ...
            <div className="flex items-center justify-center space-x-4">
              <span className={`text-sm font-mono font-medium ${!isAnnual ? 'text-secondary-900 dark:text-secondary-100' : 'text-secondary-500 dark:text-secondary-400'}`}>
                Monthly
              </span>
              <button
              ...
              {isAnnual && (
                <span className="inline-flex items-center px-2 py-1 bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-300 rounded-full text-xs font-mono font-medium">
                  Save 20%
                </span>
              )}
            </div>
              ...
              >
                ...
                <CardContent>
                  <div className="text-center mb-8">
                    <h3 className="text-xl font-semibold font-mono mb-2 text-secondary-900 dark:text-white">{tier.name}</h3>
                    <div className="mb-4">
                      <span className="text-4xl font-semibold font-mono text-secondary-900 dark:text-white">{getPrice(tier)}</span>
                      {tier.id !== 'enterprise' && (
                        <span className="text-secondary-500 dark:text-secondary-400 ml-1 font-mono">
                          {getPeriod(tier)}
                        </span>
                      )}
                    </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-semibold font-mono">Zauren</span>
              </div>
